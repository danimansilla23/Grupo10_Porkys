...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2024 a las 18:03:56
...
(3, 16, 1, 3500.00, NULL, 14),
(3, 17, 2, 2000.00, 'Rico', 15);
...
(16, 'Rogel', '3500', '28', 'Sucesivas galletas neutras alternando con abundante dulce de leche y finalmente cubierto por una capa de merengue.', NULL, '/rogel.png'),
(17, 'Rogel', '1000', '10', 'Sucesivas galletas neutras alternando con abundante dulce de leche y finalmente cubierto por una capa de merengue.', NULL, '/rogel.png'),
(18, 'Rogel', '1500', '18', 'Sucesivas galletas neutras alternando con abundante dulce de leche y finalmente cubierto por una capa de merengue.', NULL, '/rogel.png'),
(22, 'Chesscake', '2000', '18', 'Postre elegante y delicioso, con una base de galleta crujiente y una crema suave y cremosa de queso con un toque ácido.', 2, '/chesscake.png');
...
--
ALTER TABLE `carritos_x_productos`
  MODIFY `idPrdutosCarrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
